...
namespace MvcEventCalendar.Models
{
    public partial class ShoppingCart
    {
        ...
        {
            // Multiply event price by count of that event to get 
            // the current price for each of those events in the cart
            // sum all event price totals to get the cart total
            decimal? total = (from cartItems in storeDB.Carts
                              where cartItems.CartId == ShoppingCartId
                              select (int?)cartItems.Count * cartItems.Event.Price).Sum();
        ...
        public int CreateOrder(Order order)
        {
            ...
            foreach (var item in cartItems)
            {
                ...
                orderTotal += (item.Count * item.Event.Price);
            }
